...
KNOCKOUT_MATCHES: list[Match] = [
    ...
    Match(match_id=74, stage="R32", group=None, date_str="2026-06-29",
          utc_hour=17, utc_min=0, team1="Brazil", team2="Japan",
          venue="AT&T Stadium, Dallas"),
    Match(match_id=75, stage="R32", group=None, date_str="2026-06-29",
    ...
    Match(match_id=77, stage="R32", group=None, date_str="2026-06-30",
          utc_hour=17, utc_min=0, team1="Ivory Coast", team2="Norway",
          venue="Mercedes-Benz Stadium, Atlanta"),
    Match(match_id=78, stage="R32", group=None, date_str="2026-06-30",
    ...
    Match(match_id=80, stage="R32", group=None, date_str="2026-07-01",
          utc_hour=16, utc_min=0, team1="England", team2="DR Congo",
          venue="Lumen Field, Seattle"),
    Match(match_id=81, stage="R32", group=None, date_str="2026-07-01",
    ...
    Match(match_id=83, stage="R32", group=None, date_str="2026-07-02",
          utc_hour=19, utc_min=0, team1="Spain", team2="Austria",
          venue="Gillette Stadium, Boston"),
    Match(match_id=84, stage="R32", group=None, date_str="2026-07-02",
    ...
    Match(match_id=86, stage="R32", group=None, date_str="2026-07-03",
          utc_hour=18, utc_min=0, team1="Australia", team2="Egypt",
          venue="Levi's Stadium, San Francisco"),
    Match(match_id=87, stage="R32", group=None, date_str="2026-07-03",
    ...
    Match(match_id=88, stage="R32", group=None, date_str="2026-07-04",
          ...
          venue="Mercedes-Benz Stadium, Atlanta"),
    # --- Round of 16 ---
    Match(match_id=89, stage="R16", group=None, date_str="2026-07-04",
          utc_hour=17, utc_min=0, team1="Paraguay", team2="France",
          venue="Lincoln Financial Field, Philadelphia"),
    Match(match_id=90, stage="R16", group=None, date_str="2026-07-04",
          utc_hour=21, utc_min=0, team1="Canada", team2="Morocco",
          venue="NRG Stadium, Houston"),
    Match(match_id=91, stage="R16", group=None, date_str="2026-07-05",
          utc_hour=17, utc_min=0, team1="Brazil", team2="Norway",
          venue="MetLife Stadium, New York/New Jersey"),
    Match(match_id=92, stage="R16", group=None, date_str="2026-07-05",
          utc_hour=21, utc_min=0, team1="Mexico", team2="England",
          venue="Estadio Azteca, Mexico City"),
    Match(match_id=93, stage="R16", group=None, date_str="2026-07-06",
          utc_hour=17, utc_min=0, team1="Portugal", team2="Spain",
          venue="AT&T Stadium, Dallas"),
    Match(match_id=94, stage="R16", group=None, date_str="2026-07-06",
          utc_hour=21, utc_min=0, team1="United States", team2="Belgium",
          venue="Lumen Field, Seattle"),
    Match(match_id=95, stage="R16", group=None, date_str="2026-07-07",
          utc_hour=17, utc_min=0, team1="Argentina", team2="Egypt",
          venue="Mercedes-Benz Stadium, Atlanta"),
    Match(match_id=96, stage="R16", group=None, date_str="2026-07-07",
          utc_hour=21, utc_min=0, team1="Switzerland", team2="Colombia",
          venue="BC Place, Vancouver"),
    # --- Quarter-finals ---
    Match(match_id=97, stage="QF", group=None, date_str="2026-07-09",
    ...
    Match(match_id=98, stage="QF", group=None, date_str="2026-07-11",
          ...
          venue="SoFi Stadium, Los Angeles"),
    Match(match_id=99, stage="QF", group=None, date_str="2026-07-11",
    ...
    Match(match_id=102, stage="SF", group=None, date_str="2026-07-16",
          ...
          venue="Mercedes-Benz Stadium, Atlanta"),
    # --- Third-place & Final ---
    Match(match_id=103, stage="3rd", group=None, date_str="2026-07-18",
          utc_hour=21, utc_min=0, team1="TBD", team2="TBD",
          venue="Hard Rock Stadium, Miami"),
    Match(match_id=104, stage="F", group=None, date_str="2026-07-19",
...
_KNOCKOUT_RESULTS: dict[int, str] = {
    ...
    95: "3-2",            # Argentina 3-2 Egypt
    96: "0-0 (pen 4-3)",  # Switzerland 0-0 Colombia (90'+aet), Switzerland wins 4-3 pen
}
